...
print("_0 means broken state/observation, _1 means broken state/observation\n");
...
print("3. Given the sensor observation sequence (observed_broken, observed_broken, observed_broken) as evidence, what is the probability that the valve state is broken at the third time step?");
...
print("5. Given the evidence that the valve state at the second time step is normal, what is the probability of observing sensor value observed_broken at the third time step?");
